...
namespace SmartBooks.Persitence.Migrations
{
    ...
    [Migration("20210226131923_aaddd")]
    partial class aaddd
    {
            ...
            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.MemberAccountType", b =>
                {
                    ...
                    b.ToTable("MemberAccountTypes");

                    b.HasDiscriminator<string>("Discriminator").HasValue("MemberAccountType");
                });
            ...
            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.SavingsItem", b =>
                {
                    ...
                    b.Property<int>("MinContributionBeforeWithdraw")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.SharesItem", b =>
                {
                    ...
                    b.Property<decimal>("MinimumAmount")
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)")
                        .HasColumnName("SharesItem_MinimumAmount");
            ...
            modelBuilder.Entity("SmartBooks.Domains.Entities.GeneralLedger", b =>
                {
                    ...
                    b.HasOne("SmartBooks.Domains.Entities.TransactionItem", null)
