...
namespace SmartBooks.Persitence.Migrations
{
    ...
    [Migration("20210308084254_AddingFees")]
    partial class AddingFees
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartBooks.Domains.Entities.TransactionDetail", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("TransactionDetail");
                });
            ...
            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.MemberAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MemberAccountTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MemberAccountTypeId");
            ...
            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.Transactions.AddFees", b =>
                {
                    b.HasBaseType("SmartBooks.Domains.Entities.Transaction");

                    b.HasDiscriminator().HasValue("AddFees");
                });

            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.Transactions.FeeItem", b =>
                {
                    b.HasBaseType("SmartBooks.Domains.Entities.TransactionDetail");
                    ...
                    b.HasDiscriminator().HasValue("FeeItem");
                });
            ...
            modelBuilder.Entity("SmartBooks.Domains.Entities.TransactionDetail", b =>
                {
                    ...
                    b.HasOne("SmartBooks.Domains.Entities.TransactionItem", "TransactionItem")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.MemberAccount", b =>
                {
                    b.HasOne("SmartBooks.Domains.SaccoEntities.MemberAccountType", "MemberAccountType")
                        .WithMany()
                        .HasForeignKey("MemberAccountTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("MemberAccountType");
                });
            ...
            modelBuilder.Entity("SmartBooks.Domains.SaccoEntities.Transactions.FeeItem", b =>
                {
                    b.HasOne("SmartBooks.Domains.SaccoEntities.MemberAccount", "MemberAccount")
                        .WithMany()
