...
import { PaymentTerms } from 'src/app/models/payment-term';
...
@Component({
  selector: 'app-payment-terms-main',
  templateUrl: './payment-terms-main.component.html',
  styleUrls: ['./payment-terms-main.component.css']
})
export class PaymentTermsMainComponent implements OnInit, OnDestroy {

  listData: MatTableDataSource<PaymentTerms>;
